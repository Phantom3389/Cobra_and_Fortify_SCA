...
class AddJob(Resource):
    ...
    def post():
        ...
        elif a_sid.isalnum() is not True:
            return {"code": 1003, "msg": "Sid Only support num[0-9] and alpha[A-Z][a-z]"}
    ...
    def post():
        ...
        if file_instance and allowed_file(file_instance.filename):
            ...
            try:
                ...
                fortify_engine.start(dst_directory, None, 'stream', None, a_sid=a_sid)
