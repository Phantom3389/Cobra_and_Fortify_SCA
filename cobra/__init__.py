...
def main():
    try:
        ...
        parser_group_scan.add_argument('-d', '--debug', dest='debug', action='store_true', default=True, help='open debug mode')
        ...
        parser_group_server.add_argument('-H', '--host', dest='host', action='store', default="192.168.1.13", metavar='<host>', help='REST-JSON API Service Host')
        parser_group_server.add_argument('-P', '--port', dest='port', action='store', default="8888", metavar='<port>', help='REST-JSON API Service Port')
